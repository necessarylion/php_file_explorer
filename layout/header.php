<header>
  ...
  <nav>
    <a class="toggle_view" title="<?= @$_COOKIE['fe_view'] == 'listView' ? 'Grid View' : 'List View'; ?>">
      <svg class="grid-view-icon" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
      ...
      <svg class="list-view-icon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        x="0px" y="0px" viewBox="0 0 427.1 427.1" style="enable-background:new 0 0 427.1 427.1;" xml:space="preserve">
        <g>
          <g>
        ...
        <g>
          <g>
            <path
              d="M380.55,172.5h-203.5c-5.5,0-10,4.5-10,10s4.5,10,10,10h203.5c5.5,0,10-4.5,10-10S386.05,172.5,380.55,172.5z" />
          </g>
        </g>
        <g>
          <g>
            <path
              d="M286.65,234.5h-109.6c-5.5,0-10,4.5-10,10s4.4,10,10,10h109.6c5.5,0,10-4.5,10-10S292.15,234.5,286.65,234.5z" />
          </g>
        </g>
        <g>
          <g>
        ...
        <g>
          <g>
            <path
              d="M380.55,15.5h-203.5c-5.5,0-10,4.5-10,10s4.5,10,10,10h203.5c5.5,0,10-4.5,10-10S386.05,15.5,380.55,15.5z" />
          </g>
        </g>
        <g>
          <g>
            <path
              d="M286.65,78.5h-109.6c-5.5,0-10,4.5-10,10s4.4,10,10,10h109.6c5.5,0,10-4.5,10-10S292.15,78.5,286.65,78.5z" />
          </g>
        </g>
        <g>
          <g>
        ...
        <g>
          <g>
            <path
              d="M380.55,328.5h-203.5c-5.5,0-10,4.5-10,10s4.5,10,10,10h203.5c5.5,0,10-4.5,10-10S386.05,328.5,380.55,328.5z" />
          </g>
        </g>
        <g>
          <g>
            <path
              d="M286.65,391.5h-109.6c-5.5,0-10,4.5-10,10s4.5,10,10,10h109.6c5.5,0,10-4.5,10-10S292.15,391.5,286.65,391.5z" />
          </g>
        </g>
        <g>
        </g>
      ...
      <span class="list-view-icon">List View</span>
      <span class="grid-view-icon">Grid View</span>
    </a>

    <a onclick="modal('on', '#uploadModal');" title="Upload">
      ...
      Upload</a>
    <a onclick="modal('on', '#newDirModal');" title="New Folder">
      <svg height="394pt" viewBox="0 -8 394 394" width="394pt" xmlns="http://www.w3.org/2000/svg">
        <path
      ...
      New Folder</a>
    <a onclick="modal('on', '#newFileModal');" title="New File">
      <svg id="Capa_1" enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512"
        xmlns="http://www.w3.org/2000/svg">
        <g>
          <path
            d="m343.5 172.281c0-4.142-3.358-7.5-7.5-7.5h-255c-4.142 0-7.5 3.358-7.5 7.5s3.358 7.5 7.5 7.5h255c4.142 0 7.5-3.358 7.5-7.5z" />
          <path
            d="m266.365 231.448h-185.365c-4.142 0-7.5 3.358-7.5 7.5s3.358 7.5 7.5 7.5h185.365c4.142 0 7.5-3.358 7.5-7.5s-3.358-7.5-7.5-7.5z" />
          <path
            d="m81 313.115h185.365c4.142 0 7.5-3.358 7.5-7.5s-3.358-7.5-7.5-7.5h-185.365c-4.142 0-7.5 3.358-7.5 7.5s3.358 7.5 7.5 7.5z" />
          <path
            d="m81 379.781h255c4.142 0 7.5-3.358 7.5-7.5s-3.358-7.5-7.5-7.5h-255c-4.142 0-7.5 3.358-7.5 7.5s3.358 7.5 7.5 7.5z" />
          <path
          ...
          <path
            d="m449.748 264.781h-41.248v-41.248c0-4.142-3.358-7.5-7.5-7.5s-7.5 3.358-7.5 7.5v41.248h-41.248c-4.142 0-7.5 3.358-7.5 7.5s3.358 7.5 7.5 7.5h41.248v41.248c0 4.142 3.358 7.5 7.5 7.5s7.5-3.358 7.5-7.5v-41.248h41.248c4.142 0 7.5-3.358 7.5-7.5s-3.358-7.5-7.5-7.5z" />
        </g>
      </svg>
      New File</a>
    <a class="logout" title="Logout">
      <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        x="0px" y="0px" viewBox="0 0 511.989 511.989" style="enable-background:new 0 0 511.989 511.989;"
        xml:space="preserve">
        <g>
          <g>
            <g>
